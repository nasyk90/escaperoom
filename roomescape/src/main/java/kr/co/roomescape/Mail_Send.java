...
public class Mail_Send 
{
	...
	public int setEmail(String email, String subject, String body) throws Exception 
	{
	     ...
	     final String username = "team_escape"; // 송신자 네이버 아이디
	     final String password = "yuna0327!!"; // 송신자 네이버 비밀번호  
	     int port=465;
	     int state=0;
	     ...
	     mimeMessage.setFrom(new InternetAddress("team_escape@naver.com")); // 송신자 네이버 주소
