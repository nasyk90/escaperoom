...
public class FBoardCommand {

	public void f_board(HttpServletRequest request, BoardDao dao, Model model) {
		int page;
		...
		ArrayList<FboardDto> list = dao.f_board(index);
		// view전달할 값 => page,pstart,pend,page_cnt
		// page_cnt(총페이지)
		int chong = dao.chong_record();// 총레코드
