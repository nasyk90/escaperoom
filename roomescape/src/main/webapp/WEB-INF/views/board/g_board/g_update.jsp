...
<body>
<form method="post" action="g_update_ok">
	<input type="hidden" name="page" value="${page}">
	<input type="hidden" name="id" value="${gdto.id}">
	<div id="section">
		<div>
			<h1 align="center"> 게 시 판 </h1>
			<h4 align="center"> 공 지 사 항 </h4>
			<br><br>
		</div>
		<table align="center" cellspacing="0" width="1200" id="table">
			<tr id="line1" align="center"> 
				<td width="150" style="background:#eaeaea">제목</td>
				<td width="900"><input type="text" name="title" id="bb" value="${gdto.title}"></td>
			</tr>
			<tr id="line2" align="center">
				<td width="150" style="background:#eaeaea">내용</td>
				<td><textarea cols="40" rows="5" name="content" id="cc">${gdto.content}</textarea></td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
