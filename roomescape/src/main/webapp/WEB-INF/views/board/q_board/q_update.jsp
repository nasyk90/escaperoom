...
<body>
<form method="post" action="q_update_ok">
	...
	<div id="section">
		...
		<table align="center" cellspacing="0" width="1200" id="table">
			<tr id="line1" align="center">
				...
				<td><input type="text" name="name" id="bb" value="${name}" readonly></td>
			</tr>
			<tr id="line1" align="center">
				<td width="150" style="background:#eaeaea">제목</td>
				<td colspan="3" width="900"><input type="text" name="title" id="bb" value="${qdto.title}"></td>
			</tr>
			<tr id="line2" align="center">
				<td style="background:#eaeaea">내용</td>
				<td colspan="3"><textarea cols="40" rows="5" name="content" id="cc">${qdto.content}</textarea></td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
